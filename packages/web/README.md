...
To persist the remote workspace in Cloudflare, uncomment and fill the `d1_databases` block in `packages/web/wrangler.jsonc` with a binding named `EDITOR_TS_REMOTE_DB`.
