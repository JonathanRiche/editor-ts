...
`packages/web` is the main working demo for the repo. It is not a separate product. It is a SolidJS host app that imports the local library source from the repo root and exercises the real EditorTs runtime.
...
- The main app wiring lives in [`/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/App.tsx`](/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/App.tsx).
...
Useful scripts from [`/home/rtg/development/blinkx-projects/editor-ts/packages/web/package.json`](/home/rtg/development/blinkx-projects/editor-ts/packages/web/package.json):
...
The mode setup is in [`/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/App.tsx`](/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/App.tsx). The same-origin remote file API lives in [`/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/remoteProject.ts`](/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/remoteProject.ts).
...
- [`/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/App.tsx`](/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/App.tsx): main demo behavior and `init()` config
- [`/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/AppShell.tsx`](/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/AppShell.tsx): host UI layout
- [`/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/remoteProject.ts`](/home/rtg/development/blinkx-projects/editor-ts/packages/web/src/remoteProject.ts): same-origin remote workspace API
- [`/home/rtg/development/blinkx-projects/editor-ts/packages/web/vite.config.ts`](/home/rtg/development/blinkx-projects/editor-ts/packages/web/vite.config.ts): Vite config and local dev routing
- [`/home/rtg/development/blinkx-projects/editor-ts/core/src/core/init.ts`](/home/rtg/development/blinkx-projects/editor-ts/core/src/core/init.ts): core editor boot flow
...
If the user asks for a feature and does not specify another starter, prefer validating it in `packages/web`.
